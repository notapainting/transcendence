...
#   echo -e "${COLOR_RED}\nFailed to read dashboard JSON file.${COLOR_RESET}"
#   exit 1;
# fi

# echo -e "${COLOR_GREEN}Dashboard JSON:${COLOR_RESET}"
# echo "$DASHBOARD_JSON"
    ...
    -d'
  {
    ...
    "objects": [
      ...
      },
      {
        ...
        "attributes" : {
          "allowHidden": false,
          "fieldAttrs": "{\"@timestamp\":{\"customLabel\":\"Timestamp\"},\"client_ip\":{\"customLabel\":\"Client IP\"},\"method\":{\"customLabel\":\"Method\"},\"request\":{\"customLabel\":\"Request\"},\"status_code\":{\"customLabel\":\"Status Code\"},\"user_agent\":{\"customLabel\":\"User Agent\"},\"response_size\":{\"customLabel\":\"Response Size\"},\"log_type\":{\"customLabel\":\"Log Type\"},\"geoip.location\":{\"customLabel\":\"GeoIP Location\"},\"geoip.city_name\":{\"customLabel\":\"GeoIP City Name\"},\"geoip.continent_name\":{\"customLabel\":\"GeoIP Continent Name\"},\"geoip.country_iso_code\":{\"customLabel\":\"GeoIP Country ISO Code\"},\"geoip.country_name\":{\"customLabel\":\"GeoIP Country Name\"}}",
          "fieldFormatMap": "{}",
          "fields": "[]",
...
if [ $? -ne 0 ]; then
  echo -e "${COLOR_RED}\ncURL command failed.${COLOR_RESET}"
  exit 1
fi

# Check if the dashboard creation was successful
